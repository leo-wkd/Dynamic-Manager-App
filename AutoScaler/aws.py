...
class AWSClient:
    ...
    def grow_by_1(self):
        ...
        response = requests.post('http://127.0.0.1:5000/uhash_add', json={'id': instance.id,'ip': ip})
    ...
    def shrink_by_1(self):
        ...
        response = requests.post('http://127.0.0.1:5000/uhash_shrink', json={'id': instance.id, 'ip': ip})
